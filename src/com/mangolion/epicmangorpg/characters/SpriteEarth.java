...
public class SpriteEarth extends Character{

	public SpriteEarth() {
		super("Earth Sprite", "A floating ball of Earth with wings, mainly use Earth skills.",70, 70, 40, 40, 10, 100, 60, 10, 0, 0,new Weapon("Earth", 0, 100, Weapons.BareHand, 1, 1, 1f),  new SkillBodySlam(), new SkillBlock(), new SkillSlashBasic(), new SkillBoltRock());
