...
public class WolfGray extends Character{
	...
	public WolfGray() {
		super("Gray Wolf", "A tough, agile and deadly creature.",100, 20, 120, 50, 50, 100, 20, 25, 5, 4,new Weapon("Claws", 0, 100, Weapons.Claws, 1, 1, 1f),  new SkillSideStep(), new SkillBite(), new SkillSlashBasic(), new SkillJumpAtk(), new SkillBodySlam(), new SkillSideJump());
		addElements(new Element("Furry", 1));
		ai = new AISimple(this);
		
		addDrop(Items.mstone, 0.8f, 1);
		addDrop(Items.wolfHide, 0.8f, 1);
	}
}
