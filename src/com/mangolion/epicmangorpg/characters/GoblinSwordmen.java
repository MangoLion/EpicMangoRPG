...
public class GoblinSwordmen extends Character{

	public GoblinSwordmen() {
		super("Goblin Swordmen", "",70, 40, 100, 40, 10, 100, 10, 10, 0, 0,
				new WoodenClub(), new SkillSlashBasic(), new SkillBasicSwordCombo(), new SkillStab(),
