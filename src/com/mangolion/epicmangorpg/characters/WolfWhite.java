...
public class WolfWhite extends Character{
	...
	public WolfWhite() {
		super("White Wolf", "A tough, agile and deadly creature.",120, 20, 120, 70, 50, 100, 20, 35, 5, 4,new Weapon("Claws", 0, 100, Weapons.Claws, 1, 1, 1f),  new SkillSideStep(), new SkillBite(), new SkillSlashBasic(), new SkillJumpAtk(), new SkillBodySlam(), new SkillSideJump());
