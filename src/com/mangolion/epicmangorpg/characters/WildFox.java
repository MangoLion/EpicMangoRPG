...
public class WildFox extends Character{
	...
	public WildFox() {
		super("Wild Fox", "A small, wild fox, why are you bullying it?",50, 20, 80, 30, 10, 30, 20, 10, 0, 0,new Weapon("Fox Teeth", 0, 100, Weapons.Fang, 1, 1, 0.8f),  new SkillSideStep(), new SkillBite(), new SkillBasicSlash());
