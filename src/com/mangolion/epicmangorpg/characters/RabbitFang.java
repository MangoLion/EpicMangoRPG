...
public class RabbitFang extends Character{
	...
	public RabbitFang() {
		super("Fang Rabbit", "A more vicous (but still cute) rabbit with poisoned fangs.",50, 20, 80, 30, 10, 80, 20, 10, 0, 0,new Weapon("Paws", 0, 100, Weapons.BareHand, 1, 1, 1f),   new SkillBlock(), new SkillSideJump(), new SkillJumpAtk());
