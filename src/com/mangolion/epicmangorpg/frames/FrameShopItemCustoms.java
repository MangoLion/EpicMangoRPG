...
public class FrameShopItemCustoms extends JInternalFrame {
	...
	public FrameShopItemCustoms(String title, final LinkedList<ItemCustom> items) {
		...
		btnBuy.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (CharacterPlayer.instance.crystals >= item.price){
		...
		getContentPane().add(lblDurability);
