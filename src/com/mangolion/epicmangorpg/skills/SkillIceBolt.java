...
public class SkillIceBolt extends Skill {
	...
	public SkillIceBolt() {
		...
		addSteps(new Step(this, "IceBolt", "",ActionType.Magic, 0.3f, 0.1f, 0.1f, 0, 00, 0, 20,1f){
			@Override
			public void init() {
			strBased = false;
			intBased = true;
			dmgBase = 10;
			setElement(new Element(Elements.Ice, 1));
				super.init();
			}
			@Override
