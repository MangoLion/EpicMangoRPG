	...
	public SkillStormFire() {
		...
		addSteps(new Step(this, "Fire Storm", "",ActionType.Magic, 1f, 0.3f, 0.1f, 0.7f){
			...
			public void execute(Character target) {
				Event.addEvent(new EventFireStorm(0.3f, getCharacter(), target, 20, this));
		...
		new Step(this, "Fire Storm", "",ActionType.Magic, 0.5f, 0.3f, 0.1f, 1f){
			...
			@Override
			public void execute(Character target) {
				Event.addEvent(new EventFireStorm(0.4f, getCharacter(), target, 20, this));
				super.execute(character);
			}			
		}.setChances(1, 0, -0.2f),
		new Step(this, "Fire Storm", "",ActionType.Magic, 0.5f, 0.3f, 0.1f, 1.2f){
			...
			@Override
			public void execute(Character target) {
				Event.addEvent(new EventFireStorm(0.5f, getCharacter(), target, 20, this));
				super.execute(character);
			}			
		}.setChances(1, 0, -0.2f));
