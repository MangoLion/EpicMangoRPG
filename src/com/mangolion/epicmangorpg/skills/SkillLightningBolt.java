...
public class SkillLightningBolt extends Skill {

	public SkillLightningBolt() {
		...
		addSteps(new Step(this, "LightningBolt", "",ActionType.Magic, 0.8f, 0.1f, 0.1f, 0, 00, 0, 20,1f){
			@Override
			public void init() {
			strBased = false;
			intBased = true;
