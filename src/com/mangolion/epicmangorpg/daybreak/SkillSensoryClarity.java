...
public class SkillSensoryClarity extends Skill{

	public SkillSensoryClarity() {
		super("Sensory Clarity", "Gives a 50% increase in dex for 10 seconds, all skills used in this period will cost 20% more in everything, including time",Weapons.ALL, ActionType.Buff);
		hasTarget = false;
	...
	public static class StepFocus extends Step{
		...
		public StepFocus(Skill parent,
			...
			super(parent, "Sensory Clarity", "",ActionType.Buff, timeLoad, timeExecute, timeCooldown, 0);
